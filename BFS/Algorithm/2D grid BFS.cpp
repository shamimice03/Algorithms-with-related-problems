/*for Knight move (ঘোড়া)

direction array will be-
  int fx[]= {-2,-1, 1, 2, 2, 1,-1,-2};
  int fy[]= {-1,-2,-2,-1, 1, 2, 2, 1};

 if(fx[i]==-2 && fy[i]==-1)Move[z]="LD";
 if(fx[i]==-1 && fy[i]==-2)Move[z]="DL";
 if(fx[i]==1 && fy[i]==-2)Move[z]="DR";
 if(fx[i]==2 && fy[i]==-1)Move[z]="RD";
 if(fx[i]==2 && fy[i]==1) Move[z]="RU";
 if(fx[i]==1 && fy[i]==2)Move[z]="UR";
 if(fx[i]==-1 && fy[i]==2)Move[z]="UL";
 if(fx[i]==-2 && fy[i]==1)Move[z]="LU";
...
///we will see Knight move here; test case- a1 b2;
#include<bits/stdc++.h>
#define X first
#define Y second
